...
export const UserList = ({ socket, currentUser, onBack, onGameStart }) => {
  ...
  useEffect(() => {
    ...
    const handleChallengeAccepted = (data) => {
      // Il backend ora invia già gameId e role nell'evento challenge_accepted
      // Passiamo direttamente i dati al genitore
  ...
  }, [socket, currentUser, onGameStart]);
  ...
  const handleAcceptChallenge = () => {
    if (incomingChallenge) {
      ...
      // onGameStart verrà chiamato quando il backend invierà challenge_accepted
    }
  };
